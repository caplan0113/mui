...
if __name__ == "__main__":
    ...
    box_collision_robot_num(figsize=FIGSIZE, save=SAVE, pdf=None)
    box_time_robot_num(figsize=FIGSIZE, save=SAVE, pdf=None)
    box_cognition_time_robot_num(figsize=FIGSIZE, save=SAVE, pdf=None)
